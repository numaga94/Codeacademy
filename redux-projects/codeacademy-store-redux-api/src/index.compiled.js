(function () {
...
})()(
  {
    ...
    2: [
      ...
      { '../features/currencyFilter/CurrencyFilter.js': 4, '../features/inventory/Inventory.js': 6, react: undefined }
    ],
    3: [
      function (require, module, exports) {
        'use strict';
    ...
    4: [
      function (require, module, exports) {
        ...
        var CurrencyFilter = function CurrencyFilter(_ref) {
          ...
          return /*#__PURE__*/ _react['default'].createElement(
            ...
            /*#__PURE__*/ _react['default'].createElement('h3', null, 'Choose a currency'),
      ...
      { '../../../data.js': 1, './currencyFilterSlice.js': 5, react: undefined }
    ],
    5: [
      function (require, module, exports) {
        'use strict';
        ...
        var currencyFilterReducer = function currencyFilterReducer() {
          var currencyFilter =
            arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialCurrencyFilter;
          var action = arguments.length > 1 ? arguments[1] : undefined;
    ...
    6: [
      ...
      { '../../utilities/utilities.js': 9, '../cart/cartSlice.js': 3, './inventorySlice': 7, react: undefined }
    ],
    7: [
      function (require, module, exports) {
        'use strict';
