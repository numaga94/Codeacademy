...
// for (let eachCrew in spaceship.crew) {
//   console.log(`${eachCrew}: ${spaceship.crew[eachCrew].name}`);
// }

// for (let crewMembre in spaceship.crew) {
//   console.log(`${spaceship.crew[crewMembre].name}: ${spaceship.crew[crewMembre].degree}`);
// }

for (let crewMembre in spaceship.crew) {
    console.log(`${crewMembre}: ${spaceship.crew[crewMembre].name} \(${spaceship.crew[crewMembre].degree}\)`);
}