...
console.log(animals[foundAnimal]); // return 'elephant'
...
const startsWithS = animals.findIndex(animal =>{
    return animal[0].toLowerCase() === 's';
  });
  
  console.log(animals[startsWithS]); // return 'seal'

  // with filter method
  const allStartsWithS = animals.filter(animal =>{
    return animal[0].toLowerCase() === 's';
  }); 
  
  console.log(allStartsWithS); // return a list [ 'seal', 'salamander' ]
  
  const allStartsWithSMap = animals.map(animal =>{
    return animal[0].toLowerCase() === 's';
  });
  
  console.log(allStartsWithSMap); // return a list [ false, false, false, true, false, false, true, false ]